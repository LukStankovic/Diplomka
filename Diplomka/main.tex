...
Aplikace je pro uživatele dostupná buď jako webová stránka, jako klasická desktopová aplikace pro operační systém Windows nebo jako aplikace pro mobilní zařízení. Dále existují varianty a licence pro různé další služby. Mezi ty například patří: \cite{ref:microsoft_bi_general}
\begin{itemize}
