...
Dále kromě nástrojů sledujících životní cyklus celé aplikace byly prozkoumány \textit{Business Intelligence} aplikace. Ty slouží zejména pro shromažďovaní a zpracování velkých objemů dat, které pocházejí z~interních nebo externích systémů při vývoji a správě daného produktu. Nástroje poskytují také možnosti pro tvorbu a správu sestav, grafů a metrik. Podrobné informace o \textit{Business Intelligence} a analýzu aplikací Qlik Sense a Microsoft BI lze nalézt v příloze \ref{sec:bi}.
