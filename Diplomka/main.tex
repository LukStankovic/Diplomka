...
\Thanks{Rád bych poděkoval všem, kteří mě podporovali při tvorbě diplomové práce, především panu Ing. Svatopluku Štolfovi, Ph.D. za odbornou pomoc, praktické rady a vedení této diplomové práce a panu Ing. Zdeňku Velartovi, Ph.D za odborné a věcné připomínky při implementaci nástroje.}

% Zadame cestu a jmeno souboru ci nekolika souboru s digitalizovanou podobou zadani prace.
% Pokud toto makro zapoznamkujeme sazi se stranka s upozornenim.
\ThesisAssignmentImagePath{Diplomka/Figures/Assigment/assigment}
...
\CzechAbstract{Tato diplomová práce se zabývá zejména měřením kvalit softwarových procesů a vytvoření prototypového nástroje pro sledování a zobrazování metrik potřebných pro splnění standardu Automotive SPICE. V první části práce je rozebírána problematika správy a měření procesů. Dále je v této práci rozebrána analýza existujících řešení pro správu a měření procesů. Druhá část práce je věnována analýze a implementování prototypového nástroje, který je zaměřen na sběr dat a jejich následnou vizualizaci pomocí grafů, tabulek a odpovídajících reportů. Nástroj implementovaný v rámci této práce je koncipován jako rozšíření platformy IBM Jazz pomocí veřejného rozhraní.}


% 
\CzechKeywords{metriky, IBM Jazz, kvalita softwarového procesu, softwarové inženýrství, Automotive SPICE, PHP, Symfony, MongoDB, Docker}
