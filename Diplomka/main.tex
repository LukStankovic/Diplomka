...
Jeden z~nejdůležitějších scénářů, které se v~nástroji vyskytují je vytváření definic metrik, které následně slouží pro vytváření samotných metrik.
todo ref viz tabulka \ref{tab:use_case_definition_metric}
...
\textbf{Základní tok} &                                                                              
\begin{enumerate}
\item Administrátor na výpise definic metrik klikne na tlačítko pro přesměrování na formulář.
...
todo viz \ref{tab:use_case_create_metric}
...
\item Metriku je možné exportovat, vytvářet z~ní dokumenty a reporty.
\end{enumerate}                                                                                          
\end{tabular}
